    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aliquam, harum? Lorem ipsum dolor sit amet consectetur adipisicing elit. Error nisi eaque vel maiores excepturi, similique suscipit aliquid quis velit beatae fuga.</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="{{ route('login') }}" class="btn-get-started scrollto">Sign In</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="{{ asset('landingpage/img/polsek.png') }}" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
            ...
            <div class="col-xl-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box">
                    <div class="icon">
                        ...
                        <img src="{{ url($psycholog->gambar) }}" style="width: 100%; height: 140px;" alt="">
                    </div>
                    <h4>{{ $psycholog->judul }}</h4>
                    <p>{{ $psycholog->deskripsi }}</p>
                    <a href="{{ route('psikologi.index', $psycholog->uuid) }}" class="btn btn-outline-primary mt-2">Coba Test Psikologi</a>
                </div>
            </div>
            @endforeach
        </div>
