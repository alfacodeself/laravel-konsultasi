        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.pengaturan.profil.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <center>
                                ...
                                @else
                                    <img class="avatar-xl rounded-circle" src="{{ url(auth('user')->user()->foto) }}">
                                @endif
                            </center>
                            <div class="mb-1">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.pengaturan.profil.account') }}" method="post">
                            @csrf
                            @method('POST')
                            <div class="mb-2">
